...
impl Plugin for MovementPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Startup, (spawn_text, spawn_player));
        ...
        app.add_systems(FixedUpdate, interpolate_rendered_transform);
        // app.add_systems(
...
/// Spawn the player object and a 3D camera.
fn spawn_player(mut commands: Commands, asset_server: Res<AssetServer>, mut meshes: ResMut<Assets<Mesh>>,
...
fn advance_physics(
    ...
    {
        println!("input: {0}, {1}", input.x, input.y);
